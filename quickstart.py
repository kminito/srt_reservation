...
if __name__ == "__main__":
    ...
    start_num_trains_to_check = cli_args.numFrom
    end_num_trains_to_check = cli_args.numTo
    want_reserve = cli_args.reserve

    srt = SRT(dpt_stn, arr_stn, dpt_dt, dpt_tm, start_num_trains_to_check, end_num_trains_to_check, want_reserve)
